...
-- PAGE 14: "about to expire" report
select R."RFE_ID", 
R."NAME",
R."EXPLANATION",
R."ALT_PROTECTIONS",
...
-- PAGE 23: “select rfe” report, submit button, dynamic action
UPDATE f15e1_rfe
...
-- PAGE 23: “select rfe” report, recall button, dynamic action
UPDATE f15e1_rfe
...
-- PAGE 23: “select rfe” report, approve button, dynamic action
UPDATE f15e1_rfe
...
-- PAGE 23: “select rfe” report, return button, dynamic action
UPDATE f15e1_rfe
...
-- PAGE 23: “select rfe” report, reject button, dynamic action
UPDATE f15e1_rfe
...
-- PAGE 31: approval review date form
Begin
    :P31_RFE_ID := :P23_RFE_ID;
END;


-- PAGE 31: approval review date form Create Button dynamic action
UPDATE f15e1_rfe
